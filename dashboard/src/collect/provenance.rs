//! The two provenance facts the backend has to remember between sessions,
//! because neither the device nor the setup form can supply them.
//!
...
//! session can count.
//!
//! Both live in one CBOR file under `config/`, alongside `collection.json` and
